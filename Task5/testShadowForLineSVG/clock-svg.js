...
(function() {
    ...
    // Можно создать Фильтр:

    // let defs = document.createElementNS(svgNS,"defs");
    // svg.appendChild(defs);
    // let filterHand  = document.createElementNS(svgNS,"filter");
    // filterHand.setAttributeNS(null,"id", "shadowHand");
    // filterHand.setAttributeNS(null,"filterUnits", "userSpaceOnUse"); - это для того что бы можно было задать тень линии.
    // defs.appendChild(filterHand);
    // let feDropShadowHand = document.createElementNS(svgNS,"feDropShadow");
    // feDropShadowHand.setAttributeNS(null,"dx", 0);
    // feDropShadowHand.setAttributeNS(null,"dy", 0);
    // feDropShadowHand.setAttributeNS(null,"stdDeviation", 0.2);
    // feDropShadowHand.setAttributeNS(null,"flood-color", "black");
    // feDropShadowHand.setAttributeNS(null,"flood-opacity", 1);
    // filterHand.appendChild(feDropShadowHand);
    ...
    // hourHandIn.setAttributeNS(null,"filter", "url(#shadowHand)"); - так добавляется фильтр
