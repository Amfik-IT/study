...
function moovePlayerOne(direction) {
    switch (direction) {
        case 1:
            divPlayerOne.style.top = divPlayerOne.offsetTop - 4 + "px"; // Сдвинуть левую платформу вверх
            ...
            break;
        case -1:
            divPlayerOne.style.top = divPlayerOne.offsetTop + 4 + "px"; // Сдвинуть левую платформу вниз
...
function moovePlayerTwo(direction) {
    switch (direction) {
        case 1:
            divPlayerTwo.style.top = divPlayerTwo.offsetTop - 4 + "px"; // Сдвинуть правую платформу вверх
            ...
            break;
        case -1:
            divPlayerTwo.style.top = divPlayerTwo.offsetTop + 4 + "px"; // Сдвинуть правую платформу вниз
